...
public class Concept extends Thing {
	 ...
	 * @param model an RDF2Go model
	 * @param objectValue
	 * @return all A's as RDF resources, that have a relation 'Tag' to this Concept instance
	 *
	...
	public static ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllTag_Inverse( Model model, Object objectValue) {
		return Base.getAll_Inverse(model, Feature.TAG, objectValue);
	}
	...
	public ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllTag_Inverse() {
		return Base.getAll_Inverse(this.model, Feature.TAG, this.getResource() );
	}

	/**
	 * @param model an RDF2Go model
	 * @param objectValue
	 * @return all A's as a ReactorResult, that have a relation 'Tag' to this Concept instance
	 *
	...
	public static ReactorResult<org.ontoware.rdf2go.model.node.Resource> getAllTag_Inverse_as( Model model, Object objectValue) {
		return Base.getAll_Inverse_as(model, Feature.TAG, objectValue, org.ontoware.rdf2go.model.node.Resource.class);
	}
